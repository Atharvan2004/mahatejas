...
function handleAcceptOrder(o_id) {
  async function acceptOrder() {
    const { data } = await axios.put(`process.env.URLadmin/orders/${o_id}/Accepted-By-Admin`);
    if (data.order) {
      alert("Item Accepted")
      return true;
    }
...
function handleCancelOrder(o_id) {
  async function cancelOrder() {
    const { data } = await axios.put(`process.env.URLadmin/orders/${o_id}/Cancelled-By-Admin`);
    if (data.order) {
