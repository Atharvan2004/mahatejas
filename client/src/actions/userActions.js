...
export const loadUser = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("process.env.URLuser/profile");
...
export const logoutUser = () => async (dispatch) => {
  try {
    const { data } = await axios.get("process.env.URLuser/logout");
